    ...
    <>
      ...
      <div className="min-h-screen overflow-x-hidden flex flex-col gap-10">
        ...
        <footer className="bg-gray-900 text-gray-400 text-center py-6">
          <p className="text-sm">
            © {new Date().getFullYear()} CodeHub @ UGA. All rights reserved.
          </p>
        </footer>
      </div>
    </>
...
function About() {
  return (
    <section className="px-4 text-gray-800">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10 p-10 ">
        {/* Text Content */}
        <div className="flex-1 max-w-3xl">
          ...
          <p className="text-lg md:text-xl mb-6 leading-relaxed">
            CodeHub is a student-led tech organization at the University of
            Georgia that helps students of all experience levels learn to code
            and build real projects. Through weekly sessions and team-based
            semester projects, members can join either the Learn Track (for web
            development or Python) or the Project Track (for building full apps
            with a team). No prior experience needed, just curiosity and a
            willingness to build.
          </p>
          <ul className="text-base md:text-lg leading-relaxed space-y-4">
            <li>
              <strong>Skill Development:</strong> Learn web development or
              Python from the ground up through beginner-friendly weekly
              sessions. No experience required.
            </li>
            <li>
              <strong>Community & Collaboration:</strong> Be part of an
              inclusive student-led tech club where you can meet others, share
              ideas, and grow together regardless of your major or background.
            </li>
            <li>
              <strong>Project Experience:</strong> Join teams to build creative,
              semester-long projects that help you practice real coding skills
              and create portfolio-ready work.
            </li>
          </ul>
        </div>

        <div className="relative flex-1 max-w-md aspect-square overflow-hidden">
          <ExportedImage
            src="/class.jpg"
            alt="Image of codehub classroom"
    ...
    <section className="bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 py-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl mb-8">
          Whether you're a beginner or a seasoned developer, CodeHub is your
          space to grow, build, and shine. Join our community or check out past
