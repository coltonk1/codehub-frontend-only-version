...
export default async function TemplatesPage({ searchParams }) {
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://codehub-uga.com/templates" />
      </Head>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {templates.map((t) => (
              <div
                key={t.id}
                className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-sm transition duration-200"
              >
